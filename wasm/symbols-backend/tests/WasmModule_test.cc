...
symbols_backend::PluginRegistryContext<
    symbols_backend::WasmPlatform, lldb_private::FileSystem,
    lldb_private::CPlusPlusLanguage, lldb_private::TypeSystemClang,
    lldb_private::wasm::ObjectFileWasm, lldb_private::wasm::SymbolVendorWasm,
    symbols_backend::WasmProcess, symbols_backend::SymbolFileWasmDWARF>
    c;
