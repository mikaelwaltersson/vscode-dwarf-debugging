...
public:
  static llvm::SmallVector<SubObjectInfo, 1>
  GetMembers(lldb_private::CompilerType type);

  SubObjectInfo(llvm::StringRef name, uint64_t offset_in_parent,
                lldb_private::CompilerType type)
      : ObjectInfoBase(true, type), identifier_(name),
