...
public:
  ...
  static llvm::Expected<std::unique_ptr<WasmModule>>
  CreateFromFile(llvm::StringRef path);
  ...
  GetSourceLocationFromOffset(lldb::addr_t offset,
  ...
  FindType(llvm::StringRef name) const;

  llvm::Expected<ExpressionResult>
  InterpretExpression(lldb::addr_t frame_offset, uint32_t inline_frame_index,
